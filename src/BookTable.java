...
public class BookTable {
    ...
    /**
     * Executes a query using the given Statement object to cleanly (re)create the
     * table in the database.
     * Can safely be call even if the table already exists but existing data will be
     * destroyed.
     *
     * This method assumes that the correct default database has been set with "USE
     * database_name;".
     * No prepared statements are used here because there is no user input to
     * sanitise and this is a query
    ...
    public static void createTable(Connection connection) throws SQLException {
        ...
        // Remove the table first if it exists to prevent a SQL error if it's already
        // there.
     ...
     * @param title      The title of the new book. (Does not need to be unique in
     *                   the database)
